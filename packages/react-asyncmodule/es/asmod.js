    ...
    var AsyncComponent = function (_Component) {
        ...
        _createClass(AsyncComponent, [{
            ...
            value: function render() {
                ...
                return isHasRender ? _render(overProps, LoadComponent) : React.createElement(LoadComponent, _extends({}, overProps, otherState));
            }
        }]);
...
var Asyncimport = function Asyncimport() {
    ...
    var mergeOption = shallowCopy({}, DEFAULTOPTIONS, initOptions);
    // `load` exist
    if (mergeOption.load) {
